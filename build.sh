...
zip -q -r "$OUT" \
    ...
    played.js archive.js clock.js audio.js judge.js wagers.js interpret.js reader.js names.js neural.js ear.js online.js live.js \
    played.css live.css stylecontent.css \
    icons/16.png icons/32.png icons/48.png icons/128.png \
    offscreen/tts.html offscreen/tts.js offscreen/ear.js \
    vendor/supabase.js vendor/LICENSE-supabase-js.txt vendor/kokoro.web.js vendor/transformers.min.js vendor/ort-wasm-simd-threaded.jsep.mjs vendor/ort-wasm-simd-threaded.jsep.wasm \
    ...
    sounds/README.txt \
    fonts/AveriaSerifLibre-Bold.ttf fonts/Anton-Regular.ttf fonts/LICENSE-AveriaSerifLibre.txt fonts/LICENSE-Anton.txt \
    -x '*.DS_Store'
ls -la "$OUT"
